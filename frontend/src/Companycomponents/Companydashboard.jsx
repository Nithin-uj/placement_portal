...
export default function Companydashboard({company,handleLogout}) {
  ...
  const DrawerList = (
    <Box sx={{ width: 200 }} role="presentation" onClick={window.innerWidth<768 ? toggleDrawer(false) : toggleDrawer(true)}>
      <b className='m-2 d-flex justify-content-center'>COMPANY</b>
      <div className='m-1 d-flex justify-content-center'><b>{company.cname.toUpperCase()}</b></div>
      {/* <div className='m-1 d-flex justify-content-center'><div>{company.email}</div></div> */}
