...
export default function Editstudentdetails({usn}) {
  ...
  return (
        ...
        <div className="card shadow">
            <div className="card-header d-flex justify-content-center"><b>Edit profile - USN :&nbsp;</b><span>{studentdetails.usn}</span>
            </div>
